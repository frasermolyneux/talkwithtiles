resource "azurerm_linux_web_app" "app" {
  ...
  resource_group_name = local.selected_service_plan.resource_group_name
  location            = local.selected_service_plan.location

  service_plan_id = local.selected_service_plan.id
